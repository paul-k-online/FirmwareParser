...
#define INTEL_R8_LSB    R"(..\..\FirmwareParser.Data\Blinker --intel --romwidth=8.hex)"
#define INTEL_R8_MSB    R"(..\..\FirmwareParser.Data\Blinker --intel --romwidth=8.i01)"
...
namespace FirmwareParser_Test
{
	...
	public:
        ...
        {
         //   intel_hex_firmware_c2000 i_c2000;
         //   i_c2000.load(INTEL_R8_MSB);
         ...
         //   Assert::AreEqual(3U, i_c2000.const_data().size());
